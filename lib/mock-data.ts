...
export const courseMaterials = [
  { id: 1, name: "具身智能导论.pdf", type: "教材", size: "12.5 MB", date: "2024-09-01", pages: 280 },
  { id: 2, name: "第一章 环境感知.pptx", type: "课件", size: "8.2 MB", date: "2024-09-05", pages: 45 },
  { id: 3, name: "第二章 世界模型.pptx", type: "课件", size: "6.8 MB", date: "2024-09-12", pages: 38 },
  { id: 4, name: "ROS2 机器人实验手册.pdf", type: "实验文档", size: "3.4 MB", date: "2024-09-15", pages: 62 },
  { id: 5, name: "Dreamer V3 论文.pdf", type: "论文", size: "5.1 MB", date: "2024-09-18", pages: 22 },
  { id: 6, name: "第三章 任务规划.pptx", type: "课件", size: "7.5 MB", date: "2024-09-20", pages: 41 },
  { id: 7, name: "MoveIt 运动规划实验.pdf", type: "实验文档", size: "2.8 MB", date: "2024-09-22", pages: 35 },
  { id: 8, name: "第四章 多智能体协同.pptx", type: "课件", size: "9.1 MB", date: "2024-09-25", pages: 52 },
];
...
export const practiceQuestions = [
  {
    ...
    answer: 0,
    explanation: "张正友标定法通过在不同角度拍摄棋盘格平面，建立平面与图像之间的单应矩阵来求解内参。",
  },
  {
    id: 2,
    type: "单选",
    ...
    answer: 0,
    explanation: "RRT每次随机采样一个目标点，找到树中距离最近的节点，朝目标点方向扩展一个固定步长生成新节点。",
  },
  {
    id: 3,
    type: "多选",
