...
export const modules: KnowledgeModule[] = [
  {
    ...
    name: '基础理论',
    color: '#3b82f6',
    description: '导论、生物运动力学与机器人机构学，奠定数学与生物学基础',
  },
  {
    id: 'generative',
    name: '生成式模型',
    color: '#a855f7',
    description: '扩散模型、Score 模型、归一化流与 Flow Matching',
  },
  {
    id: 'perception',
    name: '感知系统',
    color: '#06b6d4',
    description: '人手与机器人手、本体感觉与触觉感知',
  },
  {
    id: 'motion-control',
    name: '运动控制',
    color: '#f97316',
    description: '运动控制发展、动力学与控制、计算神经科学',
  },
  {
    id: 'world-model',
    name: '世界模型',
    color: '#8b5cf6',
    description: '视频世界模型、RSSM、Track2Act',
  },
  {
    id: 'rl',
    name: '强化学习',
    color: '#ef4444',
    description: 'MDP 到 SAC 的完整推导与 Sim-to-Real',
  },
  {
    id: 'imitation',
    name: '模仿学习',
    color: '#22c55e',
    description: '行为克隆、Diffusion Policy、视觉模仿学习',
  },
  {
    id: 'planning',
    name: '规划与操作',
    color: '#ec4899',
    description: '导航、灵巧操作与长程规划语言',
  },
];
...
export const chapters: KnowledgeChapter[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        points: [
          ...
          {
            id: 'ch01-2-3',
            title: '模仿学习与强化学习的优化目标',
            related: ['ch12-2-1', 'ch11-2-1'],
          },
        ],
      },
      {
      ...
      },
      {
        ...
        title: '练习',
        points: [
          { id: 'ch01-6-1', title: '概念题' },
          { id: 'ch01-6-2', title: '数学推导' },
          { id: 'ch01-6-3', title: '编程实践' },
          { id: 'ch01-6-4', title: '开放思考' },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      {
        id: 'ch02-s3',
        title: '论文精读：Ramdya & Ijspeert (2023)',
        points: [
      ...
      {
        id: 'ch02-s5',
        title: '核心 Takeaway 与延伸阅读',
        points: [
          { id: 'ch02-5-1', title: '五个核心洞察' },
          { id: 'ch02-5-2', title: '开放问题与研究前沿' },
          { id: 'ch02-5-3', title: '推荐延伸阅读' },
        ],
      },
      {
        id: 'ch02-s6',
        title: '练习与思考',
        points: [
          { id: 'ch02-6-1', title: '数学推导' },
          { id: 'ch02-6-2', title: '编程练习' },
          { id: 'ch02-6-3', title: '思考题' },
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        points: [
          ...
          {
            id: 'ch03-4-6',
            title: '与第 2 章连接：生物关节到机器人关节的运动学类比',
            related: ['ch02-2-4'],
          },
        ],
      },
      {
        ...
        title: '核心 Takeaway 与延伸阅读',
        points: [
          { id: 'ch03-5-1', title: '五个核心洞察' },
          { id: 'ch03-5-2', title: '开放问题与研究前沿' },
          { id: 'ch03-5-3', title: '推荐延伸阅读' },
        ],
      },
      {
        id: 'ch03-s6',
        title: '练习与思考',
        points: [
          { id: 'ch03-6-1', title: '基础练习' },
          { id: 'ch03-6-2', title: '编程练习' },
          { id: 'ch03-6-3', title: '思考题' },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: '核心 Takeaway 与延伸阅读',
        points: [
          { id: 'ch04-5-1', title: '五个核心洞察' },
          { id: 'ch04-5-2', title: '延伸阅读' },
        ],
      },
      {
        id: 'ch04-s6',
        title: '练习与思考',
        points: [
          { id: 'ch04-6-1', title: '基础练习' },
          { id: 'ch04-6-2', title: '编程练习' },
          { id: 'ch04-6-3', title: '思考题' },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        title: '本章概要',
        points: [
          { id: 'ch05-1-1', title: '核心问题与动机' },
          { id: 'ch05-1-2', title: '本章结构' },
        ],
      },
      {
        id: 'ch05-s2',
      ...
      {
        id: 'ch05-s3',
        title: '论文精读：A Century of Robotic Hands',
        points: [
          { id: 'ch05-3-1', title: '论文定位与贡献' },
          { id: 'ch05-3-2', title: '方法论：199 款手的数据库分析' },
          { id: 'ch05-3-3', title: '两条核心趋势的证据' },
          { id: 'ch05-3-4', title: '应用领域的驱动因素' },
          { id: 'ch05-3-5', title: '范式后果：从刚性到软体操作' },
          { id: 'ch05-3-6', title: '论文的局限性与未回答问题' },
        ],
      },
      {
        id: 'ch05-s4',
        title: '算法与代码实现',
        points: [
          { id: 'ch05-4-1', title: '基础数学工具' },
          { id: 'ch05-4-2', title: '接触模型定义' },
          { id: 'ch05-4-3', title: '抓取矩阵与力封闭判定' },
          { id: 'ch05-4-4', title: '多指手雅可比与指尖力反解' },
          { id: 'ch05-4-5', title: '完整示例：三指手三棱柱抓取' },
          { id: 'ch05-4-6', title: 'LEAP Hand 与简化设计原理' },
        ],
      },
      {
        id: 'ch05-s5',
        title: '核心 Takeaway 与延伸阅读',
        points: [
          { id: 'ch05-5-1', title: '五个核心洞察' },
          { id: 'ch05-5-2', title: '开放问题' },
          { id: 'ch05-5-3', title: '推荐延伸阅读' },
        ],
      },
      {
        id: 'ch05-s6',
        title: '练习与思考',
        points: [
          { id: 'ch05-6-1', title: '基础练习' },
          { id: 'ch05-6-2', title: '编程练习' },
          { id: 'ch05-6-3', title: '思考题' },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: '核心 Takeaway 与延伸阅读',
        points: [
          { id: 'ch06-5-1', title: '五个核心洞察' },
          { id: 'ch06-5-2', title: '三个开放问题' },
          { id: 'ch06-5-3', title: '推荐延伸阅读' },
        ],
      },
      {
        id: 'ch06-s6',
        title: '练习与思考',
        points: [
          { id: 'ch06-6-1', title: '基础练习' },
          { id: 'ch06-6-2', title: '进阶思考' },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: '核心 Takeaway 与延伸阅读',
        points: [
          { id: 'ch07-5-1', title: '五个核心洞察' },
          { id: 'ch07-5-2', title: '开放问题' },
          { id: 'ch07-5-3', title: '推荐延伸阅读' },
        ],
      },
      {
        id: 'ch07-s6',
        title: '练习与思考',
        points: [
          { id: 'ch07-6-1', title: '基础练习' },
          { id: 'ch07-6-2', title: '编程实践' },
          { id: 'ch07-6-3', title: '深层思考' },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: '算法与代码实现',
        points: [
          { id: 'ch08-4-1', title: '离散时间 LQR' },
          { id: 'ch08-4-2', title: '迭代 LQR (iLQR)' },
          { id: 'ch08-4-3', title: '模型预测控制 (MPC)' },
          { id: 'ch08-4-4', title: '完整示例：倒立摆 (Cart-Pole) 的 iLQR 控制' },
      ...
      },
      {
        ...
        title: '核心 Takeaway 与延伸阅读',
        points: [
          { id: 'ch08-5-1', title: '五个核心洞察' },
          { id: 'ch08-5-2', title: '开放问题' },
          { id: 'ch08-5-3', title: '推荐延伸阅读' },
        ],
      },
      {
        id: 'ch08-s6',
        title: '练习与思考',
        points: [
          { id: 'ch08-6-1', title: '基础练习' },
          { id: 'ch08-6-2', title: '编程练习' },
          { id: 'ch08-6-3', title: '论文思考题' },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      {
        id: 'ch09-s3',
        title: '论文精读：Land et al. (1999) 茶实验',
        points: [
          { id: 'ch09-3-1', title: '论文贡献陈述' },
          { id: 'ch09-3-2', title: '实验设计与方法' },
          { id: 'ch09-3-3', title: '注视与动作的时间耦合' },
          { id: 'ch09-3-4', title: '四类注视功能' },
          { id: 'ch09-3-5', title: '对象相关动作 (ORA) 作为行为基本单元' },
          { id: 'ch09-3-6', title: '补充发现与后续影响' },
        ],
      },
      {
        id: 'ch09-s4',
      ...
      },
      {
        ...
        title: '核心 Takeaway 与延伸阅读',
        points: [
          { id: 'ch09-5-1', title: '五个核心洞察' },
          { id: 'ch09-5-2', title: '开放问题' },
          { id: 'ch09-5-3', title: '延伸阅读' },
        ],
      },
      {
        id: 'ch09-s6',
        title: '练习与思考',
        points: [
          { id: 'ch09-6-1', title: '基础练习' },
          { id: 'ch09-6-2', title: '编程练习' },
          { id: 'ch09-6-3', title: '思考题' },
        ],
      },
    ],
  },
    ...
    sections: [
      { id: 'ch10-s1', title: '本章概要', points: [{ id: 'ch10-1-1', title: '本章概要' }] },
      {
        ...
        points: [
          ...
          {
            id: 'ch10-2-5',
            title: 'Track2Act 的点轨迹预测与刚体变换推断',
            prerequisites: ['ch03-2-3'],
          },
        ],
      },
      {
      ...
      },
      {
        ...
        title: '核心 Takeaway 与延伸阅读',
        points: [
          { id: 'ch10-5-1', title: '五个核心洞察' },
          { id: 'ch10-5-2', title: '开放问题' },
          { id: 'ch10-5-3', title: '推荐延伸阅读' },
        ],
      },
      {
        id: 'ch10-s6',
        title: '练习与思考',
        points: [
          { id: 'ch10-6-1', title: '基础练习' },
          { id: 'ch10-6-2', title: '编程练习' },
          { id: 'ch10-6-3', title: '思考题' },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: '核心 Takeaway 与延伸阅读',
        points: [
          { id: 'ch11-5-1', title: '核心洞察' },
          { id: 'ch11-5-2', title: '开放问题' },
          { id: 'ch11-5-3', title: '推荐延伸阅读' },
        ],
      },
      {
        id: 'ch11-s6',
        title: '练习与思考',
        points: [
          { id: 'ch11-6-1', title: '基础练习' },
          { id: 'ch11-6-2', title: '进阶练习' },
          { id: 'ch11-6-3', title: '开放研究问题' },
        ],
      },
    ],
  },
    ...
    sections: [
      { id: 'ch12-s1', title: '本章概要', points: [{ id: 'ch12-1-1', title: '本章概要' }] },
      {
        ...
        points: [
          ...
          {
            id: 'ch12-2-5',
            title: 'Diffusion Policy：条件去噪过程',
            prerequisites: ['ch04-2-1'],
            related: ['ch13-2-2'],
          },
      ...
      },
      {
        ...
        title: '论文精读',
        points: [
          { id: 'ch12-3-1', title: '策略表示的分类学' },
          { id: 'ch12-3-2', title: '实验设计与关键结果解读' },
          { id: 'ch12-3-3', title: '消融实验中的关键洞察' },
          { id: 'ch12-3-4', title: '局限性分析' },
        ],
      },
      {
        id: 'ch12-s4',
        ...
        points: [
          ...
          { id: 'ch12-4-2', title: '视觉编码器' },
          { id: 'ch12-4-3', title: 'CNN-based Diffusion Policy' },
          { id: 'ch12-4-4', title: 'Transformer-based Diffusion Policy' },
          { id: 'ch12-4-5', title: '完整训练与推理流程' },
          { id: 'ch12-4-6', title: '数据归一化' },
        ],
      },
      {
        id: 'ch12-s5',
        title: '核心 Takeaway 与延伸阅读',
        points: [
          { id: 'ch12-5-1', title: '核心洞察' },
          { id: 'ch12-5-2', title: '开放问题' },
          { id: 'ch12-5-3', title: '推荐延伸阅读' },
        ],
      },
      {
        id: 'ch12-s6',
        title: '练习与思考',
        points: [
          { id: 'ch12-6-1', title: '基础练习' },
          { id: 'ch12-6-2', title: '编程练习' },
          { id: 'ch12-6-3', title: '思考题' },
        ],
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: '论文精读：UMI',
        points: [
          { id: 'ch13-3-1', title: '问题的精确表述' },
          { id: 'ch13-3-2', title: '论文的方法论架构' },
      ...
      },
      {
        ...
        title: '核心 Takeaway 与延伸阅读',
        points: [
          { id: 'ch13-5-1', title: '五个核心洞察' },
          { id: 'ch13-5-2', title: '局限性' },
          { id: 'ch13-5-3', title: '推荐延伸阅读' },
        ],
      },
      {
        id: 'ch13-s6',
        title: '练习与思考',
        points: [
          { id: 'ch13-6-1', title: '基础练习' },
          { id: 'ch13-6-2', title: '编程练习' },
          { id: 'ch13-6-3', title: '思考题' },
        ],
      },
    ],
  },
    ...
    sections: [
      { id: 'ch14-s1', title: '本章概要', points: [{ id: 'ch14-1-1', title: '本章概要' }] },
      {
        ...
        points: [
          {
            id: 'ch14-2-1',
            title: 'RMA 的 Teacher-Student 蒸馏框架',
            prerequisites: ['ch11-2-5', 'ch11-2-6'],
          },
      ...
      },
      {
        ...
        title: '核心 Takeaway 与延伸阅读',
        points: [
          { id: 'ch14-5-1', title: '五个核心洞察' },
          { id: 'ch14-5-2', title: '开放问题' },
          { id: 'ch14-5-3', title: '推荐延伸阅读' },
        ],
      },
      {
        id: 'ch14-s6',
        title: '练习与思考',
        points: [
          { id: 'ch14-6-1', title: '基础练习' },
          { id: 'ch14-6-2', title: '编程练习' },
          { id: 'ch14-6-3', title: '思考题' },
        ],
      },
    ],
  },
  {
    ...
    part: '第三部分：学习范式与案例',
    moduleId: 'planning',
    summary: 'GOAT 目标导航与野外视觉导航的可穿越性估计。',
    isCaseStudy: true,
    sections: [
      ...
      },
      {
        ...
        title: '算法与代码实现',
        points: [
          { id: 'ch15-4-1', title: '核心网络架构' },
          { id: 'ch15-4-2', title: '训练损失函数' },
          { id: 'ch15-4-3', title: '在线训练循环' },
          { id: 'ch15-4-4', title: '训练技巧与工程细节' },
        ],
      },
      {
        id: 'ch15-s5',
        title: '核心 Takeaway 与延伸阅读',
        points: [
          { id: 'ch15-5-1', title: '核心洞察' },
          { id: 'ch15-5-2', title: '开放问题' },
          { id: 'ch15-5-3', title: '推荐延伸阅读' },
        ],
      },
      {
        id: 'ch15-s6',
        title: '练习与思考',
        points: [
          { id: 'ch15-6-1', title: '基础练习' },
          { id: 'ch15-6-2', title: '综合思考' },
          { id: 'ch15-6-3', title: '代码实验' },
        ],
      },
    ],
  },
  {
    ...
    part: '第三部分：学习范式与案例',
    moduleId: 'planning',
    summary: '阻抗/导纳控制、Sim-to-Real 与顺应性操作。',
    isCaseStudy: true,
    sections: [
      { id: 'ch16-s1', title: '本章概要', points: [{ id: 'ch16-1-1', title: '本章概要' }] },
      {
        id: 'ch16-s2',
        title: '数学基础：阻抗/导纳与 Sim-to-Real',
        points: [
      ...
      },
      {
        ...
        points: [
          {
            id: 'ch16-3-1',
            title: 'Recipe - 人形机器人灵巧操作的 Sim-to-Real RL',
            cases: ['ch11-3-2'],
            prerequisites: ['ch12-2-5'],
          },
      ...
      },
      {
        ...
        title: '核心 Takeaway 与延伸阅读',
        points: [
          { id: 'ch16-5-1', title: '五个核心洞察' },
          { id: 'ch16-5-2', title: '开放问题' },
          { id: 'ch16-5-3', title: '推荐延伸阅读' },
        ],
      },
      {
        id: 'ch16-s6',
        title: '练习与思考',
        points: [
          { id: 'ch16-6-1', title: '基础练习' },
          { id: 'ch16-6-2', title: '编程练习' },
          { id: 'ch16-6-3', title: '思考题' },
        ],
      },
    ],
  },
    ...
    sections: [
      { id: 'ch17-s1', title: '本章概要', points: [{ id: 'ch17-1-1', title: '本章概要' }] },
      {
        ...
        points: [
          {
            id: 'ch17-2-1',
            title: 'Vision-Language-Action (VLA) 模型形式化',
            mistakes: ['m-vla'],
            related: ['ch12-2-5'],
          },
      ...
      },
      {
        ...
        title: '课程总结与未来展望',
        points: [
          { id: 'ch17-5-1', title: '17 章知识地图' },
          { id: 'ch17-5-2', title: '核心开放挑战' },
          { id: 'ch17-5-3', title: '通向通用具身智能的路线图' },
        ],
      },
      {
        id: 'ch17-s6',
        title: '核心 Takeaway 与延伸阅读',
        points: [
          { id: 'ch17-6-1', title: '核心洞察' },
          { id: 'ch17-6-2', title: '延伸阅读' },
        ],
      },
      {
        id: 'ch17-s7',
        title: '练习与思考',
        points: [
          { id: 'ch17-7-1', title: '基础题' },
          { id: 'ch17-7-2', title: '进阶题' },
          { id: 'ch17-7-3', title: '开放研究问题' },
        ],
      },
    ],
  },
...
export const commonMistakes: CommonMistake[] = [
  ...
  },
  {
    ...
    right:
      'SO(3) 李群本身无奇异；应通过李代数 so(3)（旋转向量/反对称矩阵）参数化以避免欧拉角奇异。',
  },
  {
    id: 'm-cpg',
    pointId: 'ch02-2-1',
  ...
  },
  {
    ...
    right:
      'RSSM 用循环状态空间模型分离确定性与随机潜变量，并通过变分推断学习潜在动态，而非逐帧像素预测。',
  },
  {
    id: 'm-sim2real',
    pointId: 'ch11-2-7',
    title: 'Sim-to-Real 直接迁移',
  ...
  },
  {
    id: 'm-vla',
    pointId: 'ch17-2-1',
    title: 'VLA 仅是 LLM 接机器人',
    wrong: '把 VLA 简单理解为把大语言模型接到机器人执行器。',
    right:
      'VLA 是端到端多模态 Transformer，直接映射视觉-语言到连续动作；π0.5 等还引入空间推理与长程规划。',
  },
];

export const allPoints: KnowledgePoint[] = chapters.flatMap((c) =>
  c.sections.flatMap((s) => s.points),
);
