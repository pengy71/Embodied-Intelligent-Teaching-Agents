...
export const defaultLearningEvents: TeachingLearningEvent[] = [
  ...
  event('ev-101', '2024005', 'study', 'ch10-1-1', 86, 45, 6),
  event('ev-102', '2024005', 'practice', 'ch10-2-1', 78, 35, 4),
  event('ev-103', '2024005', 'quiz', 'ch11-2-1', 92, 30, 2),
  event('ev-104', '2024005', 'qa', 'ch11-2-3', 84, 12, 1, {
    question: '集中式训练分布式执行如何实现？',
  }),

  event('ev-201', '2024006', 'study', 'ch09-2-2', 88, 35, 7),
  event('ev-202', '2024006', 'practice', 'ch09-2-3', 72, 25, 5),
  event('ev-203', '2024006', 'practice', 'ch13-2-2', 76, 30, 3),
  event('ev-204', '2024006', 'quiz', 'ch13-3-1', 70, 24, 1),

  event('ev-301', '2024007', 'study', 'ch13-1-1', 70, 32, 8),
  event('ev-302', '2024007', 'qa', 'ch13-2-1', 62, 10, 4, {
    question: 'LLM 任务规划如何避免幻觉？',
  }),
  event('ev-303', '2024007', 'practice', 'ch13-2-2', 64, 28, 2),
  event('ev-304', '2024007', 'quiz', 'ch13-2-3', 58, 20, 1),

  event('ev-401', '2024008', 'study', 'ch10-1-1', 60, 30, 9),
  event('ev-402', '2024008', 'qa', 'ch10-2-1', 48, 12, 6, {
    question: 'Dreamer 的 latent dynamics 是什么？',
  }),
  event('ev-403', '2024008', 'practice', 'ch13-2-2', 52, 24, 3),
  event('ev-404', '2024008', 'quiz', 'ch13-3-1', 46, 18, 1),
];
