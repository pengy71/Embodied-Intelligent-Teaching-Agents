...
export default function StudentPracticePage() {
  ...
  const startSession = (
    result: { roundId: string; questions: PracticeQuestion[] },
    mode: PracticeMode,
    test: StageTest | null,
  ) => {
  ...
  const startTest = async (test: StageTest) => {
    const result = await generate('test', {
      chapterIds: test.config.chapterIds,
          ...
          <div className="flex items-center justify-between">
            ...
            {mode === 'test' ? (
              <Button
                variant="outline"
                size="sm"
                onClick={() => stageTests.refresh()}
                disabled={stageTests.isLoading}
              >
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            {isTest ? (
              <Button variant="outline" size="sm" onClick={clearTestSession}>
                返回列表
              </Button>
            ) : (
                ...
                <div className="mb-3 flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <div className="mb-2 flex flex-wrap items-center gap-2">
                      ...
                      <Badge variant={DIFF_VARIANT[q.difficulty]} className="text-xs">
        ...
        <div className="mb-3 flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="mt-2 space-y-1 text-xs text-muted-foreground">
              ...
              <p>
                {q.type === 'choice' || q.type === 'fill' ? '正确答案' : '参考答案'}：
                {correctAnswerText(q)}
              </p>
            ...
            {g.attribution && (
              <div className="mt-2 rounded-md border border-amber-200/50 bg-amber-50/40 p-2.5 text-xs">
                <div className="mb-1 flex items-center gap-2">
                  <Badge variant="outline" className="text-xs">
                    {CAUSE_LABEL[g.attribution.cause]}
                  </Badge>
      ...
      <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-end gap-2">
              {isTest ? (
                <Button variant="outline" onClick={clearTestSession}>
                  返回测试列表
                </Button>
              ) : (
                <>
